  ...
  return (
    <div id="disqualified">
      ...
      <p className="contact-agent">
        For further assistance please contact an agent at{' '}
        <a href="tel:555-0109">555-0109</a> or{' '}
        <a href="mailto:customerservice@example.org">
          customerservice@example.org
        </a>
      </p>
    </div>
  );
