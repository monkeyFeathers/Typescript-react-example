import { ThunkAction, configureStore, createSlice, Action, PayloadAction } from '@reduxjs/toolkit';
...
export const requestQualify = (data: QualificationData): AppThunk => async (dispatch) => {
...
const toPageFromLoanStatus = (loanStatus: LoanStatus): Content => {
    ...
    const { CreateAccountPage, DisqualifiedPage, LandingPage, LoadingPage } = Content;
